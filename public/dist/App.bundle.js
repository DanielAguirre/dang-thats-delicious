...
function ajaxHeart(e) {
  ...
  e.preventDefault();
  _axios2.default.post(this.actioin).then(function (res) {
    var isHearted = _this.heart.classList.toggle('.heart_button-hearted');
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (response) {
    ...
    var markers = places.map(function (places) {
      ...
      var marker = new google.maps.Market({ map: map, position: position });
      marker.place = place;
      return marker;
    });
    ...
    markers.forEach(function (marker) {
      return marrker.addListener('click', function () {
...
function typeAhead(search) {
  ...
  searchInput.on('keyup', function (e) {
    ...
    var items = search.querySelectorAll('.search_result');
    var next = void 0;
